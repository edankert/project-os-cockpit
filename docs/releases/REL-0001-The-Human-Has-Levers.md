...
**Step 5/6 — the tier gate.** 27 Tier 1 and 7 Tier 2 items. **16 were walked on 2026-08-10** and carry their evidence in the suite; **15 more on 2026-08-11 and one unticked**, so **30 of 34 are settled — 29 ticked, 1 reconciled — and 4 remain** — the gate is still red.

**All four that remain need the Electron shell running:** a live agent session in the embedded terminal (1.9.1, 1.10.1, 1.10.2) and two workspaces open at once (1.2.2). A harness can stub the shell but not the record, and stubbing the record would make the answer worthless — so these are a person's, at the keyboard, exactly as the suite's header says.
