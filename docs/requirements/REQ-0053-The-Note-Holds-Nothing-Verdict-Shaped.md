...
acceptance:
  - "[ ] No acceptance note in a migrated repo carries `mark`, `verdict_date`, `verdict_reason`, `invalidated_by`, `automation`, `covered_by` or `evidence`."
  - "[ ] The validator refuses one that does, and its message names the ledger as the place the value belongs."
  - "[ ] `covers:`, `tier:`, `area:` and `level:` are untouched — they state intent, not outcome."
  - "[ ] The 203 automation annotations in your-trainer survive the removal in a form FEAT-0138 can seed from."
  - "[ ] The migration refuses a second run and lists what it could not convert rather than skipping silently."
covers: []
...
- [ ] Seven fields gone from schema, template and validator.
- [ ] Validator refuses them and points at the ledger.
- [ ] Intent fields untouched.
- [ ] Automation provenance preserved.
- [ ] Migration is idempotent and reports what it skipped.
