...
- **console** · 2026-09-05 · model:claude-fable-5-1 — Measured at rest: four near cards sit under the console by 1 to 15 px (ISS-0277, ISS-0269, TASK-0595, TST-0079); the slot test treats the projected y as the card’s centre and the renderer as its top. After turning 70 degrees three cards are under it and after 126 degrees two: slots are tested for obstacles at the yaw of the last assignment. Re-assign on turn end or make the obstacle a sector of the cylinder.
