...
- **Downstream consumer** — a project-os repo (e.g. `~/Dev/repos/your-applications.com/`) that runs `docs-server` against its own `docs/` via a shim under its `tools/docs-server/`.
