...
| [PHASE-038](phases/PHASE-038-A-Verdict-Is-An-Event.md) | A verdict is an event | An acceptance verdict is a fact about **(check × platform × release)** and is stored in a scalar. It becomes a dated, attributed event in a per-release, single-platform ledger; the note keeps only intent; the walk list, release gate and cross-platform burndown become queries. Opens on [[ADR-0037]] (`proposed`, acceptance is Edwin's) — **nothing migrates until it is accepted**. | FEAT-0133..FEAT-0138, REQ-0052..REQ-0057, ISS-0216..ISS-0218 | planned |
...
**[[PHASE-037]]** — the surfaces report at the reader's granularity; opened 2026-08-18 on five defects Edwin found by use. **[[PHASE-038]]** is documented and `planned`, gated on [[ADR-0037]] being accepted. Previously: **[[PHASE-036]]** (three axes) closed 2026-08-18, and **[[PHASE-035]]** (acceptance checks become notes) closed on [[ADR-0031]] superseding [[ADR-0030]] one day after it was accepted. Previously: **[[PHASE-034]]** closed 2026-08-16 on its fourth close, after building the functionality review's four features (FEAT-0108..0111). It had opened and closed the same day after three closes and an independent review that returned `changes-requested` on the phase and five of six features; those verdicts stand.
