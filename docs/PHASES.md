...
| [PHASE-008](phases/PHASE-008-State-And-Review-Surfaces.md) | State & review surfaces | State-first overview rework (project + phase dashboards per the 2026-07-26 design dossier) and the ~review desk where agent proposals, questions, and manual test runs meet a human. | FEAT-0040, FEAT-0041 | active |
...
PHASE-008. See `SNAPSHOT.yaml` `focus.phase`.
