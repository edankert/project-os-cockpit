...
**[[PHASE-035]]** — acceptance checks become notes; opened 2026-08-17 on [[ADR-0030]] (`proposed`, acceptance is Edwin's). Previously: **[[PHASE-034]]** closed 2026-08-16 on its fourth close, after building the functionality review's four features (FEAT-0108..0111). It had opened and closed the same day after three closes and an independent review that returned `changes-requested` on the phase and five of six features; those verdicts stand.
