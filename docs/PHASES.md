...
| [PHASE-034](phases/PHASE-034-Three-Phases-And-Publication-Is-The-Third.md) | Three phases, and publication is the third | Work has a design phase, an implementation phase and a publication phase, and the tool has only ever had two. Publication becomes a view over the whole ladder — commit, push, deploy, versioned release — and every obligation routes to the phase that owns its subject, asking only while that subject is in flight. Opens on a decision ([[ADR-0028]]), not on build work. | FEAT-0101, FEAT-0102, FEAT-0108, FEAT-0109, FEAT-0110, FEAT-0111, FEAT-0104, ISS-0172, ISS-0173, ISS-0177, ISS-0183, ISS-0184, ISS-0185, ISS-0186, ISS-0187, ISS-0188, ISS-0189 | done |
| [PHASE-035](phases/PHASE-035-Acceptance-Checks-Are-Notes.md) | Acceptance checks are notes | The acceptance record moves from one grammar-bearing document to first-class `CHK-*` notes and the release process runs on them end to end: invalidation lands where work lands, walking happens on a generated view with the same marks, and Mark released freezes the record behind two refusals. Opens on a decision ([[ADR-0030]]), not on build work — nothing migrates until it is accepted. | FEAT-0113, FEAT-0114, FEAT-0115, FEAT-0116, FEAT-0117 | active |
| [PHASE-036](phases/PHASE-036-One-Human-Walk.md) | One human walk | Three axes — what a test exercises (`level:`), who runs it (`command:`) and what it gates (`covers:`) — stop being one word, and gating is derived from `covers:` at any granularity. Opens on [[ADR-0034]]. *(Row added 2026-08-19; the phase closed without one.)* | FEAT-0119..FEAT-0124, ISS-0195..ISS-0205 | done |
| [PHASE-037](phases/PHASE-037-The-Surfaces-Report-At-The-Readers-Granularity.md) | The surfaces report at the reader's granularity | Every verification surface answers the question its reader actually has. Five defects Edwin found by USE, not by audit; four are invisible to the validator and two are live PHASE-036 regressions. Opens on [[ADR-0035]] and [[DES-0012]]. *(Row added 2026-08-19.)* | FEAT-0125..FEAT-0132, ISS-0210..ISS-0213 | active |
| [PHASE-038](phases/PHASE-038-A-Verdict-Is-An-Event.md) | A verdict is an event | An acceptance verdict is a fact about **(check × platform × release)** and is stored in a scalar. It becomes a dated, attributed event in a per-release, single-platform ledger; the note keeps only intent; the walk list, release gate and cross-platform burndown become queries. Opens on [[ADR-0037]], accepted 2026-08-19 and **amended once after** (decision 9a, closing [[ISS-0220]]). **Closed 2026-08-19** on all nine exit criteria; Stage 2 ([[FEAT-0138]], observed coverage) re-homed to PHASE-999 as its own body of work. | FEAT-0133..FEAT-0137, REQ-0052..REQ-0056, ISS-0206, ISS-0216..ISS-0221 | done |
...
**[[PHASE-037]]** — the surfaces report at the reader's granularity; opened 2026-08-18 on five defects Edwin found by use. **[[PHASE-038]]** closed 2026-08-19: a verdict is an event in a per-release, single-platform ledger, and the note holds intent only. Previously: **[[PHASE-036]]** (three axes) closed 2026-08-18, and **[[PHASE-035]]** (acceptance checks become notes) closed on [[ADR-0031]] superseding [[ADR-0030]] one day after it was accepted. Previously: **[[PHASE-034]]** closed 2026-08-16 on its fourth close, after building the functionality review's four features (FEAT-0108..0111). It had opened and closed the same day after three closes and an independent review that returned `changes-requested` on the phase and five of six features; those verdicts stand.
