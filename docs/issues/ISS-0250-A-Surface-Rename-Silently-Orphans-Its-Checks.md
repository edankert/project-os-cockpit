...
**Verdict: approved.** Untouched in `c4413e3..9784205` beyond the appended sixth-pass section; `SURFACE-ORPHAN` still reports one finding per orphaned name and the validator runs clean at zero errors with the rule live.
