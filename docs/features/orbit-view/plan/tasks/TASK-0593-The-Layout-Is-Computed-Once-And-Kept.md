...
**The hard half is growth.** This corpus added 634 notes in one month. A new note must be placed near its links without displacing what is already there — otherwise every remembered position is wrong the next morning, which is worse than never having offered stability. [[DES-0013]]'s ATLAS objection is the same problem stated for a map, and the answer is likely the same: allocate with room, and spill at the edge rather than re-solving the interior.
