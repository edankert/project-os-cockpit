...
depends: []
blocks: ["TASK-0594"]
related: ["[[DES-0013-Nine-Ways-To-Read-The-Record]]", "[[DES-0002-Cockpit-Design-System]]"]
tests: []
---
...
Decide between the three treatments [[DES-0013]] draws, and record why. A design verdict is human-only ([[REQ-0026]]); this task ends in Edwin's decision, not in an implementation.
...
- The decision recorded in [[DES-0013]]'s frontmatter, with the reason
- If blocks win, what replaces the edge callout is answered before [[TASK-0594]] starts
- If glass wins, the four collapsed status hues are answered before [[TASK-0594]] starts
