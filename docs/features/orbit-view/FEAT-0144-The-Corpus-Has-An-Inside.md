...
requirements: []
tasks: ["[[TASK-0592-The-Whole-Edge-List-Is-One-Payload]]", "[[TASK-0593-The-Layout-Is-Computed-Once-And-Kept]]", "[[TASK-0594-The-Field-Renders-And-Flies]]", "[[TASK-0595-Landing-Opens-The-Note]]", "[[TASK-0596-The-Treatment-Is-Chosen-Not-Assumed]]"]
release: ""
acceptance_exception: ""
acceptance: ""
design: "[[DES-0013-Nine-Ways-To-Read-The-Record]]"
related: ["[[DES-0013-Nine-Ways-To-Read-The-Record]]", "[[FEAT-0093-A-Cross-Repo-Link-Carries-Its-Parts]]", "[[ADR-0009-Notes-Are-The-Authored-Source-Of-State]]"]
---
...
The first is a query a table could answer, and [[DES-0013]] says so plainly in ORBIT's own objection. The second and third are not.

## Scope

- `~orbit` as a cockpit route, reachable from the rail and from any note ("show this in the field")
- Node colour is the **status band from `statuses.py`** — no second vocabulary ([[ISS-0023]])
...
- **Editing from the field.** No verb is discharged here. Obligations live with their subject ([[ADR-0020]]) and the field is not their subject.
- **The fleet as one graph.** One sidecar serves one repo ([[FEAT-0093]]); a cross-repo field is a separate question and is not answered here.
- **The visual treatment**, which is [[TASK-0596]] and [[DES-0013]]'s open decision D1 — constellation, glass or blocks.

## Open decision

**D1 — constellation, glass or blocks.** [[DES-0013]] draws three treatments of the same view, live and switchable: a near-black sky of luminous points; a cyan instrument with brackets and billboarded panes; and opaque painted-wood solids on a lit table. They differ in what they make easy to believe, not only in how they look, and two of them cost something real — glass collapses four of the six status hues into 25 degrees, and blocks cannot draw the 16148 edges at all. The choice is Edwin's. Nothing else in this feature depends on it except [[TASK-0594]]'s renderer.
