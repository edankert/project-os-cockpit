---
name: cockpit-driving
description: "project-os cockpit driving playbook"
---

<!-- generated by tools/scripts/generate-adapters.py from tools/skills/cockpit-driving/SKILL.md; edit the source and re-run, do not edit this file -->

This operation is governed by the canonical project-os playbook.

1. Read `tools/skills/cockpit-driving/SKILL.md` in full — it is the source of truth for this skill.
