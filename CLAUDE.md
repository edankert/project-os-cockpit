...
A second application, **Deck**, is being built in `~/Dev/repos/project-os-deck` beside this one. It shares this repository's sidecar. Its design collateral moved there on 2026-09-06 (DES-0013 and DES-0014 became `project-os-deck#DES-0001` and `#DES-0002`, FEAT-0144 became `#FEAT-0001` with TASK-0001 to 0005; the counters here were not reused). The options that led to it are `project-os-deck: docs/reference/cockpit-surface-architecture-options-2026-09-06.md`, and Deck's adoption table against the register below is `project-os-deck: docs/reference/cockpit-adoption.md`.
...
**This cockpit stays the primary place for new functionality.** Edwin, 2026-09-06: it is too early to say that new cockpit functionality should land in Deck instead. The functionality the projects need is built here; Deck keeps an eye on it through the register and must be able to support it going forward. An earlier wording the same day said this cockpit was frozen except for fixes; that was reversed within the hour and is not the rule.
