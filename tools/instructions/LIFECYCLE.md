...
8. **Release the cockpit to project-os** (this repo only — see `../../docs/requirements/REQ-0017-Release-To-Project-Os.md`):
   - If the close-out CHG touches `src/project_os_cockpit/` or `pyproject.toml`, the agent MUST run
     `tools/scripts/release-to-project-os.sh` to refresh the project-os copy at
     `~/Dev/repos/project-os/tools/cockpit/`, then commit the result inside project-os.
