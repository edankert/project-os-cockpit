...
- *That first bullet was ambiguous until 2026-08-18 (ISS-0196): this file said the gate applied to "any change that creates or updates a `TST-*`" while `TESTING.md` said it was keyed on the status, and the validator implements the status reading. Under ADR-0031 the difference stopped being academic — the note-touched reading would have made several hundred migrated acceptance tests gate-bearing overnight. The status reading is the rule.*
